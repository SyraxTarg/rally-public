...
import { fetchReasonsApi, postSignaledCommentApi } from "@/app/server_components/api";
...
export default function SignalCommentModal({ isOpen, comment_id, onClose }: SignalCommentModalProps) {
  ...
  const onSignal = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await postSignaledCommentApi(JSON.stringify({
